...
namespace LKSN2017
{
    public partial class frmManageTeacher : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            txtId.Text = "T" + randomNumber.ToString();
        }
            ...
            if (jenis.Equals("insert"))
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        cmd = new SqlCommand("insert into [Teacher] values ('" + txtId.Text.ToString() + "','" + txtName.Text.ToString() + "','" + txtPhone.Text.ToString() + "','" + dateStudent.Value.ToString("yyyy-MM-dd") + "','" + gender  + "','" + txtAddress.Text.ToString() + "','" + null + "')", conn);
                        cmd.ExecuteNonQuery();
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        cmd = new SqlCommand("Update [Teacher] set TeacherId = '" + txtId.Text.ToString() + "', Name = '" + txtName.Text.ToString() + "', Address = '" + txtAddress.Text.ToString() + "',Gender = '" + gender.ToString() + "', DateofBirth = '" + dateStudent.Value.ToString("yyyy-MM-dd") + "', PhoneNumber = '" + txtPhone.Text.ToString() + "' where TeacherId = '" + txtId.Text + "' ", conn);
                        cmd.ExecuteNonQuery();
                        String password = txtName.Text[0].ToString().ToUpper() + txtName.Text.Length.ToString().ToLower() + dateStudent.Value.ToString("yyyy");
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            SqlConnection conn = koneksi.getKoneksi();
            conn.Open();
            string query = "Select * From [Teacher] where TeacherId Like '" + textBox1.Text + "%' or Name Like '" + textBox1.Text + "%' or PhoneNumber Like '" + textBox1.Text + "%'";
            cmd = koneksi.getData(query, conn);
